...
@section('content')
    <div class="row align-items-center h-100 m-0">
        ...
        <div class="col-md-6 col-sm-8 border-left h-100 d-flex flex-column justify-content-center px-4 bg-white">
            ...
            <form method="POST" action="{{ route('register') }}" class="mb-auto">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6 col-sm-6">
                        ...
                        <input type="text" class="form-control{{ $errors->has('first_name') ? ' is-invalid' : '' }}"
                               id="first_name" name="first_name" placeholder="Prénom" value="{{ old('first_name') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control{{ $errors->has('username') ? ' is-invalid' : '' }}"
                           id="username" name="username" placeholder="Pseudo" value="{{ old('username') }}">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="password"
                               ...
                               placeholder="Confirmation de mot de passe" value="{{ old('password_confirmation') }}">
            ...
            <p>Déjà un compte? <a href="{{route('connexion')}}">connectez-vous</a></p>
        </div>
    </div>
@endsection
